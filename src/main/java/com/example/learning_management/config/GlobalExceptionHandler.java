...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> buildProblemDetail(Object error) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(
                HttpStatus.BAD_REQUEST, error.toString());
        problemDetail.setProperty("timestamp", Instant.now());
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        return buildProblemDetail(message);
    }

    // Catch valid Exception @RequestBody
    @Override
    public ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        return buildProblemDetail(errors);
    }

    // ValidationException for RequestParm, PathVariable
    // @Override
